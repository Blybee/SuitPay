...
export const CLAVES_DE_CONSULTA = {
  ...
  deudasVecino: (cotizacionId: string) =>
    ['cotizaciones', 'deudas', cotizacionId] as const,
  listaRequerimiento: (vendedorId: string, fecha: string) =>
    ['lista-requerimiento', vendedorId, fecha] as const,
