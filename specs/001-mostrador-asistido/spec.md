...
- **FR-060b**: La lista MUST persistirse en Firestore (`listasRequerimiento/{uid}`) para sincronizar entre dispositivos del mismo vendedor, con `caducaEn` a 1 semana. MUST ofrecer Exportar PDF y compartir ese PDF por WhatsApp (documento interno, no un comprobante).
